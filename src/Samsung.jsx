...
function Samsung() {
    ...
    const products = [
        ...
        { id: 2, name: 'Samsung Galaxy S22 Ultra', message: "top vente", image: '/samsungSmart_pic/s22ultra.png', color: ['black', 'white', 'green'], rating: '4.7/5', reviews: 12468, currentPrice: 899.99, oldPrice: 1299.99, quantite: 1, condition: "Parfait état", vendu_avec: "Câble de chargement" },
