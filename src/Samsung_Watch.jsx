          ...
          const [minprice, setMinPrice] = useState(0);
              ...
              function filterProducts() {
                ...
                const isWatchActive2Matched = 
                  ...
                  return (isModelMatched || isWatch4ClassicMatched || isWatch4Matched || isWatch6Matched || isWatchUltraMatched || isWatch5Matched || isWatch3Matched || isWatchFEMatched || isWatchActive2Matched) && isColorMatched && isPriceMatched;
                });
                    ...
                    <div className="intro">
                      {/* une introduction avec un titre et un paragraphe */}
                        <div className="sometext">
                          <h1>Samsung Smart-Watches reconditionnés</h1>
                          <p>Vous cherchez une Samsung Smart-Watches reconditionné ? Bingo ! Nous sommes les maîtres des offres Samsung Smart-Watches reconditionnés. Nos Samsung Smart-Watches offrent le meilleur des deux mondes.</p>
                        </div>
