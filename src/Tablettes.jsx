...
const Tablettes = () => {
    const Tablettes = [
        ...
        { id: 4, name: 'Toutes les marques', image: '/tablets_pic/ipad1.png', lien: '/Tablettes/AllTablettes' }
    ];
  ...
  return (
    <><div className="smartphones-page">
          ...
          <h1 className='a12'>Tablettes</h1>
          <p className="subtitlee">Achetez des Tablettes et plus encore</p>
